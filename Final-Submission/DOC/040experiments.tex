...
\begin{figure}[!ht]
    \centering
    \subfigure{\includegraphics[scale=0.4]{ROC_Curve_DARPA_TCP_Dump.pdf}}
    \subfigure{\includegraphics[scale=0.4]{ROC_Curve_AirForce_TCP_Dump.pdf}}
...
\begin{figure}[!ht]
    \centering
    \subfigure{\includegraphics[scale=0.4]{Acuuracy_DARPA_TCP_Dump.pdf}}
    \subfigure{\includegraphics[scale=0.4]{Acuuracy_AirForce_TCP_Dump.pdf}}
